...
function TraderBlock(
  ...
  return (
    ...
    >
      <div>
        <div className="text-xs font-bold mb-2 text-center bg-neutral-900 p-2 pr-4 pl-20 h-[50px] flex flex-col items-center justify-center relative overflow-hidden">
          <Image
